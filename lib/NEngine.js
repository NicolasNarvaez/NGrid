    ...
    renderer = (function() {
      ...
      function resize() {
        ...
        mat5.projectionLen(PMatrix,
          ...
          options_init.projection_angle,
          options_init.projection_angle, options_init.projection_near, options_init.projection_far);
      ...
      function render() {
        ...
        if(obj_list.length) {
          ...
          for(obj_list_i=obj_list.length; obj_list_i--;) {
            ...
            mat5.multiply(m_objectRotation, m_cameraRotation, matrix_tmp); //multiply
            mat5.copy(matrix_tmp, m_objectRotation);
            ...
            //left draw
            vec4.copy(tmp_vec1, camera.rz);
            vec4.copy(tmp_vec2, camera.rx);
            //math.rotateNormalized(tmp_vec1, tmp_vec2, -Math.PI/8);
            math.rotateNormalized(tmp_vec1, tmp_vec2, 0);

            mat4.rotationVecs(m_cameraRotation3, tmp_vec2, camera3.ry, tmp_vec1);
            mat4.translate(matrix_tmp, m_cameraRotation3, [0,0,0,0]);

            mat4.multiply(PMVMatrix3, PMatrix3, matrix_tmp);
            mat4.copy(PMVMatrix3, PMatrix3);
