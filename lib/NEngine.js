  ...
  this.NEngine = (function() {
    ...
    renderer = (function() {
      ...
      function init(options) {
        ...
        math.mat = global['mat'+(config.dim+1)];
        math.mat_cartesian = global['mat'+config.dim];

        math.vec = global['vec'+config.dim];
        math.vec_homogenous = global['vec'+(config.dim+1)];
      ...
      function resize() {
        ...
        if(config.view_3d_projection === 'perspective')
          ...
          mat4.ortogonalLen(PMatrix3,
            ...
            config.view_3d_projection_ortogonal_aspect_x,
            config.view_3d_projection_ortogonal_aspect_y)
      }
      ...
      function render() {
        ...
        if(obj_list.length) {
          ...
          for(obj_list_i=obj_list.length; obj_list_i--;) {
            ...
            else if(config.view_3d === 'flat' || !config.view_3d) {
              //rotar mundo
              mat4.rotationVecs(m_cameraRotation3, camera3.rx, camera.ry, camera.rz);
