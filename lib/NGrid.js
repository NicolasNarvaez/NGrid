...
(function() {
  var global = this;
    ...
    var  debugging = true,
      ...
      world_grid_unit_length = 20, world_grid_unit_size = 3,
      i_w, i_z, i_y, i_x, obj,
      enemy_geom0 = NEngine.geometry.grid4(2,2,2,2, {size: size*0.5}),
      pointer_geom = NEngine.geometry.grid4(2,2,2,2, {size: size*0.5}),
      axis = NEngine.geometry.axis4(size),
    ...
    function init(options) {
      ...
      var mt = NMath.mat3,
      a=mt.create(), b=mt.create();
      mt.copy(a,[
        1,0.5,0,
        0.5,1,0,
        0,0,1
      ])
      NMath.mat.invert(b,a);
      console.log(NMath.mat.str(a), NMath.mat.str(b));
