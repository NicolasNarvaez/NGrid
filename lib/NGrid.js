  ...
  var global = this;
    ...
    function init(options) {
      ...
      renderer.init({
        ...
        view_3d_projection_ortogonal_length : 300,
      ...
      var length = 3, size=4, enemy_geom = NEngine.geometry.grid4(2,2,2,2, {size: 0.2}),
        world_grid_geom, world_grid = [], world_grid_size = 3, world_grid_length = 90,
        world_grid_unit_length = 30, world_grid_unit_size = 2,
        world_grid_geom, world_grid = [], world_grid_size = 3, world_grid_length = 30,
        world_grid_unit_length = 30, world_grid_unit_size = 2,
        i_w, i_z, i_y, i_x, obj;
      ...
      grid = new Obj();
      grid.geom = NEngine.geometry.grid4(4,4,4,4, {size:5});
      //renderer.objAdd(grid);

      /*
      grid = new Obj();
      grid.geom = NEngine.geometry.grid4(6,6,6,6, {size:1000});
      grid.p = camera.p;
      renderer.objAdd(grid);
      */
    ...
    enemigos.add_pass(function(obj, tmp_v1, tmp_v2, tmp_m1, tmp_m2) {
      ...
      mat4.invert(tmp_m2, tmp_m1);

      mat4.multiplyVec(tmp_v2, tmp_m2, tmp_v1);
      //console.log(obj.p);
      ...
      vec4.normalize(tmp_v2,tmp_v2);
      vec4.normalize(tmp_v1,tmp_v1);

      vec4.plane(tmp_v2, tmp_v1);
      mat4.rotationPlane(tmp_m2, tmp_v2, tmp_v1, dt*Math.PI/(180*10));

      mat4.multiply(tmp_m3, tmp_m2, tmp_m1);
      vecs = NMath.mat.vecs(tmp_m3);
      vec4.ortogonalize(vecs);
