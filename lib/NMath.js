...
(function() {
  ...
  */
  ...
  mat4.rotationPlane = function(out, v1, v2, theta, print) {
  ...
  */
  ...
  vec4.rotateOnPlane = function(out, v, v1, v2, theta, print) {
  ...
  vec4.rotateAbsolute = function(obj) {
    ...
    mat4.multiply(m_tmp1, m_tmp2, m_data);
  ...
  vec4.rotateNormalizedRelative = function(vecs, a,b ,theta) {
    ...
    NMath.mat5.rotateAxis(m_rotation, a, b, theta);
  ...
  /**
  * Flips va over vb (uses vb has a mirror)
  * @function flip
  */
    ...
    */
    ...
    generators = (function() {
      ...
      vec={
        ...
        plane: function(dim) {
          var mod = 'vec'+dim;
          return 'var t='+mod+'.create();'+
            mod+'.projection(t,a,b);'+
            mod+'.sub(a,a,t);'+
            mod+'.normalizeI(a);'+
            mod+'.normalizeI(b);'
        },
